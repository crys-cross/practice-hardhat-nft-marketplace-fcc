...
// From https://github.com/Fantom-foundation/Artion-Contracts/blob/5c90d2bc0401af6fb5abf35b860b762b31dfee02/contracts/FantomMarketplace.sol
...
contract NftMarketplace is ReentrancyGuard {
    ...
    // 2 ways to do function above(2nd way chosen)
    // 1. Send the NFT to the contract. Contract will hold NFT. May be Gas expensive.
    // 2. Owners can still hold their NFT, and give marketplace approval to sell.
    ...
    function buyItem(address nftAddress, uint256 tokenId)
        ...
        nonReentrant
    {
        // Challenge TODO - How would you refactor this contract to take:
